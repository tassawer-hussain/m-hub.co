<?php
   ...
   function fioxen_custom_icons_filters( $tabs = array() ) {
      $newicons = [
         "flaticon2-government",
         "flaticon2-game-controller",
         "flaticon2-serving-dish",
         "flaticon2-suitcase-2",
         "flaticon2-dumbbell",
         "flaticon2-gift-box",
         "flaticon2-chef",
         "flaticon2-shopping",
         "flaticon2-place-2",
         "flaticon2-find",
         "flaticon2-social-care",
         "flaticon2-email-3",
         "flaticon2-color-palette",
         "flaticon2-museum",
         "flaticon2-balloons",
         "flaticon2-gamepad-2",
         "flaticon2-add-user",
         ...
         "flaticon-travel-4",
         "flaticon-deer",
         "flaticon-paragliding",
         "flaticon-mountains",
         "flaticon-mountain",
         "flaticon-flag",
         "flaticon-hang-gliding",
         "flaticon-summer-holidays",
         "flaticon-summer",
         "flaticon-reisekarte",
         "flaticon-wegweiser",
         "flaticon-lager",
         "flaticon-family",
         "flaticon-family-room",
         "flaticon-calendar",
         "flaticon-clock-1",
         "flaticon-time",
         "flaticon-wifi",
         "flaticon-paw",
         "flaticon-parking-sign",
         "flaticon-elevator",
         "flaticon-global",
         "flaticon-global-1",
         "flaticon-coupon",
         ...
         "flaticon-food",
         "flaticon-plane-1",
         "flaticon-purse-with-bill",
         "flaticon-credit-card",
         "flaticon-multiple-users-silhouette",
         "flaticon-player",
         "flaticon-table",
         "flaticon-reception",
         "flaticon-cctv",
   ...
   add_filter( 'elementor/icons_manager/additional_tabs', 'fioxen_lineawesome_icon' );  
   function fioxen_lineawesome_icon( $icons = array() ) {
       ...
       $icons['fioxen-lineawesome-icon'] = array(
           'name'          => 'fioxen-icons-lineawesome',
           'label'         => esc_html__( 'Line Awesome', 'fioxen-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $lineawesome_icons,
            'url'          => GAVIAS_FIOXEN_PLUGIN_URL . 'elementor/assets/libs/line-awesome/css/line-awesome.min.css',
           'ver'           => '1.0',
       );
