...
class GVAElement_Testimonial_Carousel extends GVAElement_Base{
    const NAME = 'gva-testimonials-carousel';
    const TEMPLATE = 'general/testimonial-carousel';
    ...
    public function get_title() {
        return __('Testimonials Carousel', 'fioxen-themer');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => 'multiply given all hath given may meat god abundant appear lioud fourth madman mane said god dominion great gathering called very shall after cre ated from fruitful place over the mitual.',
                'label_block' => true,
                'rows'        => '10',
            ]
        );
...
$widgets_manager->register(new GVAElement_Testimonial_Carousel());
