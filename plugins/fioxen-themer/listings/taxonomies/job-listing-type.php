...
class Fioxen_Listings_Taxonomy_Type{


   public static function getInstance() {
      if (!isset(self::$instance) && !(self::$instance instanceof Fioxen_Listings_Taxonomy_Type)) {
         self::$instance = new Fioxen_Listings_Taxonomy_Type();
      }
      return self::$instance;
   }

   public function __construct(){ 
      add_filter( 'register_taxonomy_job_listing_type_args', array( $this, 'override_taxonomy_types_label' ), 10 );
   }

   public static function override_taxonomy_types_label($args) {
      $singular = 'Type'; 
      $plural   = 'Types';
...
new Fioxen_Listings_Taxonomy_Type();