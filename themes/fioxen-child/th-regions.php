...
?>
   <div class="filter-by-region filter-by-country">
      <div class="content-inner">
         ...
         <select class="option-select2-filter job-manager-filter th-filter-listing-country" id="th-filter-listing-country" name="filter_listing_region[]" placeholder="<?php echo esc_attr__('Filter By Country', 'fioxen') ?>">
   ...
   <div class="filter-by-region filter-by-city">
      <div class="content-inner">
         ...
         <select class="option-select2-filter job-manager-filter th-filter-listing-city" id="th-filter-listing-city" name="filter_listing_region[]" placeholder="<?php echo esc_attr__('Filter By State/Province', 'fioxen') ?>">
            <?php if( !empty($d_city) ){ ?>
