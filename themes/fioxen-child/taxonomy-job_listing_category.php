...
<section id="wp-main-content" class="clearfix main-page">
   ...
   <div class="lt-main-page-content lt-page_layout-<?php echo esc_attr($layout) ?>"> 
      	...
      	<div class="container"><div class="row">
		  	<div class="content-page th-content-page col-12">
				<p class="th-desc-text">Choose your Country and State/Province to see <?php echo $term->name; ?> nearest to you.</p>
				<div class="th_search_jobs">
					<?php require_once get_stylesheet_directory( ) . '/th-regions.php' ?>
				</div>
			</div>
      	</div></div>
