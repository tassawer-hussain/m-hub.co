<?php
/**
 * Job listing in the loop style I: Without information Map
 *
 */
...
$logo = fioxen_image_attach($post_id, '_lt_logo_image', true);
...
<div <?php job_listing_class('listing-block listing-list'); ?>>
   <div class="listing-content-inner">
      ...
      <div class="listing-content">
         ...
         <div class="listing-meta">
            <?php if($city || $country){ ?>
               <div class="location">       
                  <i class="icon las la-map-marked-alt"></i>
                  <span class="regions">
                     <?php if( $city ){ ?>
            ...
            <?php if($phone){ ?>
               <div class="phone"><i class="icon las la-phone-volume"></i><a href="tel:<?php echo esc_attr($phone) ?>"><?php echo esc_html($phone) ?></a></div>
            <?php } ?> 
         </div>    
         ...
         <div class="content-footer">
            ...
            <?php 
               ...
               if( !empty($review_avg) ){
                  ...
                  echo Fioxen_Listing_Comment::instance()->show_star_by_avg($review_avg, $review_avg); 
               }
            ?>
