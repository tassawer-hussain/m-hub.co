	...
	case 'publish' :
		echo '<div class="job-manager-message">' . wp_kses_post(
			sprintf(
				...
				__( '%1$s listed successfully. To view your listing <a href="%2$s">click here</a>.', 'fioxen' ),
	...
	case 'pending' :
		echo '<div class="job-manager-message">' . wp_kses_post(
			sprintf(
				...
				esc_html__( '%s submitted successfully. Your listing will be visible once approved.', 'fioxen' ),
				esc_html( $wp_post_types['job_listing']->labels->singular_name )
			)
		) . '</div>';
	break;
