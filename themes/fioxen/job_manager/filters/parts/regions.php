...
?>
   <div class="filter-by-region filter-by-country">
      <div class="content-inner">
         ...
         <select class="option-select2-filter job-manager-filter filter-listing-country" id="filter-listing-country" name="filter_listing_region[]" placeholder="<?php echo esc_attr__('Filter By Region', 'fioxen') ?>">
   ...
   <div class="filter-by-region filter-by-city">
      <div class="content-inner">
         ...
         <select class="option-select2-filter job-manager-filter filter-listing-city" id="filter-listing-city" name="filter_listing_region[]" placeholder="<?php echo esc_attr__('Filter By City', 'fioxen') ?>">
            <?php if( !empty($d_city) ){ ?>
