...
/>
<div class="upload-image-btn"><i class="fas fa-cloud-upload-alt"></i><?php echo esc_html__( "Upload Image", 'fioxen' ) ?></div>
<small class="description">
	<?php if ( ! empty( $field['description'] ) ) : ?>
		<?php echo wp_kses_post( $field['description'] ); ?>
	<?php else : ?>
		<?php printf( esc_html__( 'Maximum file size: %s.', 'fioxen' ), size_format( wp_max_upload_size() ) ); ?>
	<?php endif; ?>
</small>
